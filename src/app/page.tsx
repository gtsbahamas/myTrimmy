      ...
      <nav className="fixed left-0 right-0 top-0 z-50 border-b border-slate-800 bg-slate-950/80 backdrop-blur-lg">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white">myTrimmy-prep</span>
          </Link>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-32 text-center sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-slate-400">
              Get started with myTrimmy-prep today. Build faster, ship sooner, and delight your users.
            </p>
      ...
      <section className="relative py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mb-10 text-lg text-slate-400">
            Join thousands of users who trust myTrimmy-prep for their needs.
          </p>
          <Button
            asChild
            size="lg"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">myTrimmy-prep</span>
            </div>
            ...
            <p className="text-sm text-slate-500">
              &copy; {new Date().getFullYear()} myTrimmy-prep. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
