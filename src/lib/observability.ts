/**
 * Observability Library - myTrimmy-prep
...
class StructuredLogger {
  ...
  constructor(config: Partial<LoggerConfig> = {}) {
    this.config = {
      service: config.service || 'my-trimmy-prep',
...
class Tracer {
  ...
  constructor(config: Partial<TracerConfig> = {}) {
    this.config = {
      serviceName: config.serviceName || 'my-trimmy-prep',
...
export function initObservability(config: {
  ...
  logger.info('Observability initialized', {
    service: config.serviceName || 'my-trimmy-prep',
