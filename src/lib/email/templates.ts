...
export function renderWelcomeEmail(data: WelcomeEmailData): EmailTemplate {
  ...
  const subject = `Welcome to myTrimmy-prep!`;
...
<body style="margin: 0; padding: 0; background-color: #f5f5f5;">
  <div style="${emailStyles.container}">
    <div style="${emailStyles.header}">
      <div style="${emailStyles.logo}">myTrimmy-prep</div>
    </div>

    <h1 style="${emailStyles.heading}">Welcome aboard, ${name}!</h1>

    <p style="${emailStyles.paragraph}">
      Thanks for signing up for myTrimmy-prep. We're excited to have you on board.
    </p>
    ...
    <div style="${emailStyles.footer}">
      <p>&copy; 2026 myTrimmy-prep. All rights reserved.</p>
      <p style="margin-top: 10px;">
        You received this email because you signed up for myTrimmy-prep.
      </p>
    </div>
  </div>
</body>
...
---
(c) 2026 myTrimmy-prep. All rights reserved.
You received this email because you signed up for myTrimmy-prep.
  `.trim();
...
export function renderPasswordResetEmail(data: PasswordResetEmailData): EmailTemplate {
  ...
  const subject = `Reset your myTrimmy-prep password`;
...
<body style="margin: 0; padding: 0; background-color: #f5f5f5;">
  <div style="${emailStyles.container}">
    ...
    <div style="${emailStyles.footer}">
      <p>&copy; 2026 myTrimmy-prep. All rights reserved.</p>
      <p style="margin-top: 10px;">
        This is an automated security email from myTrimmy-prep.
      </p>
    </div>
  </div>
</body>
  ...
  const text = `
Reset your myTrimmy-prep password
...
export function renderEmailVerificationEmail(data: EmailVerificationData): EmailTemplate {
  ...
  const subject = `Verify your email for myTrimmy-prep`;
...
<body style="margin: 0; padding: 0; background-color: #f5f5f5;">
  <div style="${emailStyles.container}">
    ...
    <p style="${emailStyles.paragraph}">
      Please verify your email address to complete your myTrimmy-prep account setup:
    </p>
    ...
    <div style="${emailStyles.warning}">
      ...
      <br><br>
      If you didn't create an account with myTrimmy-prep, you can safely ignore this email.
    </div>
  ...
  const text = `
Verify your email for myTrimmy-prep
...
export function renderSubscriptionConfirmationEmail(data: SubscriptionConfirmationData): EmailTemplate {
  ...
  const subject = `Your myTrimmy-prep ${planName} subscription is confirmed`;
...
<body style="margin: 0; padding: 0; background-color: #f5f5f5;">
  <div style="${emailStyles.container}">
    ...
    <p style="${emailStyles.paragraph}">
      Thank you for subscribing to myTrimmy-prep! Your subscription is now active.
    </p>
  ...
  const text = `
Your myTrimmy-prep ${planName} subscription is confirmed
